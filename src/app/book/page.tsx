...
export const metadata: Metadata = {
  ...
  description:
    "Book your physiotherapy consultation in Jamshedpur. Quick WhatsApp booking, flexible timings, home visits available.",
  alternates: {
    canonical: "/book",
  },
  openGraph: {
    title: "Book Appointment — Manipal Physiotherapy",
    description: "Reserve your physiotherapy session in Baridih, Jamshedpur.",
    url: "/book",
  },
};
        ...
        <div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            <a
              ...
              className="flex items-center gap-3 rounded-2xl border border-border bg-card p-4 shadow-card hover-lift"
            >
